...
<html>
	...
	<body>
		...
		<div id="loginbox" style="margin-top:50px;" class="login-form col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
		<div class="panel panel-info" >
			 <img src="../../assets/img/logo.png" class="img-responsive" alt="" />
			<div class="panel-heading">
				<div class="panel-title"><h3>Cambiar Password</h3></div>
				<div style="float:right; font-size: 80%; position: relative; top:-10px"><a href="../../index.html">Iniciar Sesi&oacute;n</a></div>
			</div>
