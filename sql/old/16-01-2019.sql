...
-- Tiempo de generación: 16-01-2019 a las 15:58:24
...
--
ALTER TABLE `bitacora`
  MODIFY `id_evento` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador del evento o acción realizada', AUTO_INCREMENT=88;
...
--
ALTER TABLE `ingresos`
  MODIFY `id_registro` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
